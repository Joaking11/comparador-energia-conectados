...
export async function GET() {
  ...
  try {
    ...
    const plantillaData = tarifasReales.map((tarifa: any) => ({
      ...
      'P1 Energía (€/kWh)': Number(tarifa.energiaP1 || 0),
      'P2 Energía (€/kWh)': Number(tarifa.energiaP2 || 0),
      'P3 Energía (€/kWh)': Number(tarifa.energiaP3 || 0),
      'P4 Energía (€/kWh)': Number(tarifa.energiaP4 || 0),
      'P5 Energía (€/kWh)': Number(tarifa.energiaP5 || 0),
      'P6 Energía (€/kWh)': Number(tarifa.energiaP6 || 0),
    ...
    const instrucciones = [
      ...
      { 'INSTRUCCIONES': '• P1/P2/P3/P4/P5/P6 Energía: Precios por periodo horario (€/kWh)' },
